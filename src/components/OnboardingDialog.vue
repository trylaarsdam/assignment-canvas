    ...
    async checkData() {
      ...
      try {
        const response = await axios.get(
          "https://canvasapi.toddr.org/internal/users/test?canvasURL=" +
            this.canvasURL +
            "&canvasKey=" +
            this.canvasKey,
          {
        ...
        const emailResponse = await axios.get(
          "https://canvasapi.toddr.org/internal/users/check?email=" +
            this.email,
          {
            auth: {
              username: this.$store.state.user.email,
    ...
    async createAccount() {
      ...
      try {
        const response = await axios.post(
          "https://canvasapi.toddr.org/internal/users/new?canvasURL=" +
            this.canvasURL +
            "&canvasKey=" +
            this.canvasKey +
            "&email=" +
